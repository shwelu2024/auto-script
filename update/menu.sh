...
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "                ${WB} ♦️ ข้อมูลเซิร์ฟเวอร์ ♦️ ${NC}             "
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
...
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "  ${RB}♦️${NC} ${YB}การใช้งานรายวัน         : $ttoday ${NC}"
echo -e "  ${RB}♦️${NC} ${YB}การใช้งานเมื่อวานนี้     : $tyest ${NC}"
echo -e "  ${RB}♦️${NC} ${YB}การใช้งานรายเดือน       : $tmon ${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
