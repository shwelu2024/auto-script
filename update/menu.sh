...
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "  ${RB}»»${NC} ${YB}OS       :  "$(hostnamectl | grep "Operating System" | cut -d ' ' -f5-) ${NC}         
echo -e "  ${RB}»»${NC} ${YB}KERNEL   :  $(uname -r) ${NC} "
echo -e "  ${RB}»»${NC} ${YB}เวลาให้บริการ   :  $uptime ${NC} "
echo -e "  ${RB}»»${NC} ${YB}CPU      :  ${cores} core ($load_cpu)  ${NC} "
echo -e "  ${RB}»»${NC} ${YB}แรม      :  $uram MB / $tram MB ${NC} "
echo -e "  ${RB}»»${NC} ${YB}โดเมน   :  $domain ${NC} "
echo -e "  ${RB}»»${NC} ${YB}Ns    :  $sldomain ${NC} "
...
echo -e "$YB 12$y. เมนู ข้อมูลพอร์ตทั้งหมด $wh"
echo -e "$YB 13$y. เมนู XRAY VERSION $wh"
echo -e "$YB 14$y. เมนู ตรวจสอบพอร์ต IP $wh"
echo -e "$YB 15$y. เมนู ตรวจสอบบริการ VPN $wh"
echo -e "$YB 16$y. เมนู อัปเดต $wh"
echo -e "$YB 17$y. เมนู แก้ไขข้อผิดพลาด SSLH + WS-TLS หลังจากรีบูต $wh"
echo -e "$YB 18$y. เมนู การตั้งค่า $wh"
echo -e "$YB 19$y. เมนู ตรวจสอบซีพียูและแรม $wh"
echo -e "$YB 20$y. เมนู ตรวจสอบแบนด์วิธ $wh"
echo -e "$YB 21$y. เมนู ตัวเปลี่ยน DNS $wh"
echo -e "$YB 22$y. เมนู ตัวตรวจสอบ NETFLIX $wh"
echo -e "$YB 23$y. เมนู ลบผู้ใช้ที่หมดอายุ $wh"
