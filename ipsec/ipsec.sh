...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/shwelu2024/auto-script/main/ipsec"
...
if [[ ${OS} == "centos" ]]; then
epel_url="https://github.com/shwelu2024/addons/releases/download/epelV9/epel-release-latest-9.noarch.rpm -E '%{rhel}').noarch.rpm"
...
swan_url1="https://github.com/shwelu2024/addons/releases/download/libreswan-3.32/libreswan-3.32.tar.gz"
swan_url2="https://github.com/shwelu2024/addons/releases/download/libreswan-3.32/libreswan-3.32.tar.gz"
