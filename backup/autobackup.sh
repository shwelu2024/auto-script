...
echo " รอสักครู่"
clear
echo " การสำรองข้อมูลอัตโนมัติได้เริ่มต้นแล้ว"
echo " ข้อมูลจะถูกสำรองข้อมูลโดยอัตโนมัติเวลา 00:05 GMT +7"
exit 0
}
function stop() {
email=$(cat /home/email)
...
echo " โปรดรอ"
clear
echo " การสำรองข้อมูลอัตโนมัติถูกหยุดแล้ว"
exit 0
}

function gantipenerima() {
rm -rf /home/email
echo "กรุณากรอกอีเมล์ของคุณ"
read -rp "อีเมล์ : " -e email
cat <<EOF>>/home/email
$email
EOF
}
